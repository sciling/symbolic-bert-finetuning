...
class Classifier:
    def __init__(self, model_name, is_multilabel=False):
        self.tokenizer = AutoTokenizer.from_pretrained('./train.dir')
        if is_multilabel:
            print('multi_label_classification')
            self.model = BertForSequenceClassification.from_pretrained('./train.dir', problem_type="multi_label_classification")
        else:
            print('single_label_classification')
            self.model = BertForSequenceClassification.from_pretrained('./train.dir')
    ...
    def classify(self, text):
        ...
        return sorted(zip(proba, self.labels), reverse=True)
