...
class Wikipedia(object):
    ...
    def redirects(
        ...
        """
        Returns redirects of the page with respect to parameters
        ...
        for k, v in pages.items():
            if k == '-1':
                ...
                return self._build_redirects(v, page)
        return {}
    ...
    def _build_redirects(
        ...
        for redirect in extract.get('redirects', []):
            p = WikipediaPage(
                wiki=self,
            ...
            page._redirects[p.title] = p

        return page._redirects
...
class WikipediaPage(object):
    ...
    * `talkid` - id of the page with discussion
    ...
    def __init__(
        ...
        self._redirects = {}  # type: PagesDict
    ...
    def redirects(self) -> PagesDict:
        ...
        * https://www.mediawiki.org/wiki/API:Redirects
        ...
        :return: :class:`PagesDict`
        """
        if not self._called['redirects']:
            self._fetch('redirects')
